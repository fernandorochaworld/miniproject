  ...
  return (
    <div class="flex min-h-full flex-col justify-center px-6 py-3 lg:px-8">
      <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Update Currency</h2>
      </div>
      ...
      <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-screen-md">
        <form class="space-y-6" action="#" method="POST">
          ...
          <div class="flex justify-center">
            <Button className="w-1/3" title="Update" onClick={handleClick} />
          </div>
        </form>
      </div>
    </div>
